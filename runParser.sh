...
\clvertalt \clshdrawnil \clwWidth3723\clftsWidth3 \clbrdrt\brdrnil \clbrdrl\brdrnil \clbrdrb\brdrnil \clbrdrr\brdrnil \clpadl200 \clpadr200 \gaph\cellx4320
...
\outl0\strokewidth0 \strokec2 files="$(ls ebay_data)" \
 args="" \
 for file in $files \
 do \
 args="$\{args\} ebay_data/$\{file\}" \
 done \
   python skeleton_parser.py $args\cell 
